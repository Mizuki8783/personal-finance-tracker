...
def plot_income_vs_spending(df):
    ...
    monthly_expenses = df[df['Type'].str.lower() == 'expense'].set_index('Date')['Amount'].resample('ME').sum()
    monthly_income = df[df['Type'].str.lower() == 'income'].set_index('Date')['Amount'].resample('ME').sum()
